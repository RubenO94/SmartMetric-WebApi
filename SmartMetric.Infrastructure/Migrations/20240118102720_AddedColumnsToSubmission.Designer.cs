...
namespace SmartMetric.Infrastructure.Migrations
{
    ...
    [Migration("20240118102720_AddedColumnsToSubmission")]
    partial class AddedColumnsToSubmission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMetric.Core.Domain.Entities.Submission", b =>
                {
                    ...
                    b.Property<int?>("EvaluatedDepartmentId")
                        .HasColumnType("int");

                    b.Property<int?>("EvaluatedEmployeeId")
                        .HasColumnType("int");

                    b.Property<int?>("EvaluatorDepartmentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartMetric.Infrastructure.Models.Perfil", b =>
                {
                    b.Property<int>("Idperfil")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SmartMetric.Infrastructure.Models.PerfisJanela", b =>
                {
                    ...
                    b.HasIndex("Idperfil", "Idjanela", "Aplicacao", "Modulo");
