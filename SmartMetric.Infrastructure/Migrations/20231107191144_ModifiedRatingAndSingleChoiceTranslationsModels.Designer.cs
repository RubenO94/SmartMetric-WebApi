...
namespace SmartMetric.Infrastructure.Migrations
{
    ...
    [Migration("20231107191144_ModifiedRatingAndSingleChoiceTranslationsModels")]
    partial class ModifiedRatingAndSingleChoiceTranslationsModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMetric.Core.Domain.Entities.RatingTemplate", b =>
                {
                    b.Property<Guid>("RatingTemplateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartMetric.Core.Domain.Entities.RatingTemplateTranslation", b =>
                {
            ...
            modelBuilder.Entity("SmartMetric.Core.Domain.Entities.SingleChoiceTemplate", b =>
                {
                    b.Property<Guid>("SingleChoiceTemplateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartMetric.Core.Domain.Entities.SingleChoiceTemplateTranslation", b =>
                {
            ...
            modelBuilder.Entity("SmartMetric.Core.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasOne("SmartMetric.Core.Domain.Entities.RatingTemplate", "RatingTemplate")
                        .WithMany()
                        .HasForeignKey("RatingTemplateId");

                    b.HasOne("SmartMetric.Core.Domain.Entities.SingleChoiceTemplate", "SingleChoiceTemplate")
                        .WithMany()
