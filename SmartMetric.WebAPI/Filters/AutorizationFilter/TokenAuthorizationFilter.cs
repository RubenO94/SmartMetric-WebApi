    ...
    public class TokenAuthorizationFilter : Attribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!string.IsNullOrEmpty(token))
            {
                ...
                {
                    context.Result = new UnauthorizedObjectResult(new { Error = "Error in authorization token processing" });
                    return;
                }
        ...
        private string DecryptToken(string encodedToken)
        {
            ...
            {
                throw new InvalidOperationException("Error decrypting bytes", ex);
            }
