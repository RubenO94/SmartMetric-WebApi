...
namespace SmartMetric.Core.DTO.Response
{
    ...
    public class RatingOptionTranslationDTOResponse
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return RatingOptionTranslationId == translation.RatingOptionTranslationId && RatingOptionId == translation.RatingOptionId && Language == translation.Language && Description == translation.Description;
        }
        ...
        {
            return $"{nameof(RatingOptionTranslationId)}: {RatingOptionTranslationId}\n{nameof(RatingOptionId)}: {RatingOptionId}\n{nameof(Description)}:{Description}\n";
        }
    }
