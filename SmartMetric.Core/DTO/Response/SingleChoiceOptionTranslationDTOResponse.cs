...
namespace SmartMetric.Core.DTO.Response
{
    ...
    public class SingleChoiceOptionTranslationDTOResponse
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return SingleChoiceOptionTranslationId == translation.SingleChoiceOptionTranslationId &&
        ...
        {
            return $"SingleChoiceOptionTranslationId: {SingleChoiceOptionTranslationId}\nSingleChoiceOptionId: {SingleChoiceOptionId}\nLanguage: {Language}\nDescription:{Description}\n";
        }
    }
